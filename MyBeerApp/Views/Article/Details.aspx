...
<div>
<% 
    ViewDataDictionary vdd = new ViewDataDictionary(new { Key = Model.Article.ArticleID });
    vdd.Add("Key", Model.Article.ArticleID);
   // Html.RenderPartial("ArticleComment", Model.ArticleComment, vdd);

    Html.RenderPartial("ArticleComment", ViewData.Eval("ArticleComment"), vdd);
